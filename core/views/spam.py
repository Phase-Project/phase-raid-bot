...
from core.config import PHASE_INVITE
...
class SpamButton(discord.ui.LayoutView):
    ...
    container1 = discord.ui.Container(
        discord.ui.TextDisplay(content=f"# PRESS BUTTON TO START SPAM!\n-# The Bot is open source so it would be really appreciated if you could star the [github repo](https://github.com/phaseworld-creator/phase-raid-bot)"),
