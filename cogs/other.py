...
from core.config import ICON, SERVER_NAME
    ...
    async def info(self, interaction: discord.Interaction):
        ...
        def make_page1():
            class Page1(discord.ui.LayoutView):
                container1 = discord.ui.Container(
                    discord.ui.Section(
                        discord.ui.TextDisplay(content="# `↯` {SERVER_NAME} Bot information\n### Links •[github](https://github.com/phaseworld-creator/phase-raid-bot)"),
                        accessory=discord.ui.Thumbnail(
                            media=ICON,
                        ),
                    ),
